...
func Solve(tests []EpdItem, eng common.IEngine, moveTime time.Duration) error {
	var start = time.Now()
...
func executeTest(test EpdItem, uciEngine common.IEngine, moveTime time.Duration) common.SearchInfo {
